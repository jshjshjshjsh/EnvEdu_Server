    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        // todo : 나중엔 꼭 삭제해야 함
                        .mvcMatchers("/educating/**","/datafolder/**","/mydata/**").permitAll()
                        .mvcMatchers("/seed/**","/air-quality/mine", "/ocean-quality/mine","/user/**","/mydata/**","/dataupload").hasAnyRole("STUDENT","EDUCATOR","MANAGER","ADMIN")
